...
//skuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu
//是否打开sku组件
...
<template>
  ...
  <!-- 骨架屏 -->
  <GoodsSkeleton v-else></GoodsSkeleton>
  <!-- 用户操作 -->
  ...
  <uni-popup ref="popup" type="bottom" background-color="#fff">
    ...
    <AddressPanel v-else-if="popupName === 'address'" @close="popup?.close()"></AddressPanel>
  </uni-popup>
</template>
